...
export default [
    <Page title="How to Vote"
        ...
        icon=""
        moreInfo="You've turned 18, now you have to vote. Make your voice heard. Come on."
        step1="Go to https://voterlookup.elections.ny.gov/ to check if you are registered to vote right now."
        step2="If you are not registered to vote, you must do so by october 17th If you are not registered, go to https://dmv.ny.gov/more-info/electronic-voter-registration-application to register. You will need your New York State DMV issued driver license, permit or Non - Driver ID the ZIP Code currently on record with the DMV the last 4 digits of your Social Security Number(SSN)."
        step3="If you don’t have a NY drivers license, or you preferto use the printable form https://www.elections.ny.gov/NYSBOE/download/voting/voteform_enterable.pdf and fill out the registration form. Send this to your respective county’s address as seen on the back of the form (Cattaraugus: 207 Rock City St.Suite 100 Little Valley, NY 14755(716) 938 - 2400)."
        step4="To register to absentee vote, go to https://www.elections.ny.gov/NYSBOE/download/voting/AbsenteeBallot-English.pdf The sooner you do this, the more informed you can be. "
        step5=" If you are voting in person, go to this link: https://www.elections.ny.gov/CountyBoards.html, to see where you can vote. To be more informed, research the candidates or go to isidewith.com.Check out the candidates for your district and take the quiz to see how your political views align with those of your candidates. "
    ...
    <Page title="How to Make Make a Pasta Dinner"
        ...
        step1="Fill your pot with 2 cups of water for every 1/2 cup of pasta, making sure there's extra room at the top so it won't boil over."
    ...
    <Page title="How to do Laundry"
        ...
        moreInfo="Laundry is confusing with all those weird symbols. It's okay, it will all make sense in a few steps."
    ...
    <Page title="How to Grade an IT-280B Project"
        ...
        step3="Remember that this project is brought to you by the letter 'N'. That is...Novice programmers."
